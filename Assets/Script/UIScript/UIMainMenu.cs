...
namespace UIScript
{
    ...
    /// <summary>
    /// Controls the main menu UI, handling navigation between different menu pages.
    /// </summary>
    public class UIMainMenu : GenericSingleton<UIMainMenu>
    {
        ...
        /// <summary>
        /// Builds the dictionary mapping each menu page to its corresponding panel.
        /// </summary>
        ...
        /// <summary>
        /// Sets up button onClick listeners to handle menu navigation.
        /// </summary>
        ...
        /// <summary>
        /// Navigates to a specified menu page.
        /// Optionally clears navigation history.
        /// </summary>
        ...
        /// <summary>
        /// Updates UI elements and panel visibility based on the current menu page.
        /// </summary>
        ...
        /// <summary>
        /// Handles back button presses, navigating to the previous page if available.
        /// </summary>
        ...
        /// <summary>
        /// Responds to scene changes, navigating to match result when returning to main menu.
        /// </summary>
        ...
        /// <summary>
        /// Waits for the match result UI to initialize before navigating to the match result page.
        /// </summary>
        ...
        [ContextMenu("GoToSettings")]
        private void GoToSettings() => NavigateTo(MenuPage.Settings);
